...
Sidebar {.sidebar}
----------------------------------------------------------------
`r h4(strong("Study:"))`  `r unique(params$study$studyid)`
`r h4(strong("Snapshot:"))`  `r Sys.Date()`
`r h4(strong("Total Patients:"))`  `r n_distinct(params$study$subjectid)`
...
Sidebar {.sidebar}
----------------------------------------------------------------
`r h4(strong("Study:"))`  `r unique(params$treatment$studyid)`
`r h4(strong("Snapshot:"))`  `r Sys.Date()`
`r h4(strong("Total Patients:"))`  `r n_distinct(params$treatment$subjectid)`
