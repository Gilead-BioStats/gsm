...
study_plot_studdata <- Make_Plot_Data(dfInput_study, strGroup = "Study")
study_plot_sitedata <- Make_Plot_Data(dfInput_study, strGroup = "Site")

treat_plot_studdata <- Make_Plot_Data(dfInput_treat, strGroup = "Study")
treat_plot_sitedata <- Make_Plot_Data(dfInput_treat, strGroup = "Site")
...
```{r}
Disc_Bar_Plot(treat_plot_studdata, strGroup = "Study")
```

Bar Plot by Site {data-height=`r round(26.06 * nrow(treat_plot_sitedata) + 108.35)`}
----------------------------------------------------------------
### <font size=5px>**Treatment Discontinuation Reasons by Site**</font>
```{r}
Disc_Bar_Plot(treat_plot_sitedata, strGroup = "Site")
```
