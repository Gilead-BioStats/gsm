...
## Subjects
status_study_exists <- !is.null(params$status_study)

if (status_study_exists ) {
  subjects <- params$status_study[[Read_Mapping()[["dfSTUDY"]][["strActualSubjectsCol"]]]]
}
...
```{r, echo=FALSE, results = 'asis', warning=FALSE, eval=status_study_exists }
