...
assessment <- AssessStatus(params$assessment, strType = "kri")
...
`r if(!is.null(dropped)){glue::glue("{length(dropped)} {ifelse(length(dropped) == 1, 'KRI', 'KRIs')} dropped in Report see [KRI Glossary]")}`
