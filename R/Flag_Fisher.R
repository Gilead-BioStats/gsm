...
#'
#' @details
#' This function flags sites based on the Fisher's Exact Test result as part of the [GSM data model](https://gilead-biostats.github.io/gsm/articles/DataModel.html).
#'
