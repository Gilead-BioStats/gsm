...
#'
#' @details
#' This function flags sites based on the Poisson analysis result as part of the [GSM data model](https://gilead-biostats.github.io/gsm/articles/DataModel.html).
#'
