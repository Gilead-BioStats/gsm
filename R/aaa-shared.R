...
#'   reporting. Created by passing an `lWorkflow` object to [gsm.mapping::MakeMetric()].
...
#'   [gsm.mapping::MakeBounds()]. Expected columns: `Threshold`, `Denominator`, `Numerator`,
...
#'   reporting. Created by passing an `lWorkflow` object to [gsm.mapping::MakeMetric()] and
