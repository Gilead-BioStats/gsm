...
PD_Assess <- function(
  ...
  if (!is.null(lTags)) {
    stopifnot(
      ...
      "lTags cannot contain elements named: 'GroupID', 'N', 'KRI', 'KRILabel', 'Score', 'ScoreLabel', 'GroupLabel', or 'Flag'" = !names(lTags) %in% c("GroupID", "N", "KRI", "KRILabel", "Score", "ScoreLabel", "GroupLabel", "Flag")
    )
