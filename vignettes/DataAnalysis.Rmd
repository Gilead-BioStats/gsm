...
A full explanation of all Data Visualizations in the `{gsm}` package is outlined in the [Reporting Workflow vignette](https://gilead-biostats.github.io/gsm/articles/DataReporting.html).
...
-   Scatter plot created from `dfTransformed` and `dfBounds` using `Visualize_Scatter()`
