...
The following sections include various examples of supporting functions and statistical models that can be employed in the `Assess()` functions. Please note that this is **not** an exahustive list, but includes some of the most commonly called upon functions.
...
-   `Transform_Count()`: Calculates cumulative numer of Event(s) of Interest per site
