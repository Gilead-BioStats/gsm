...
As an introduction, clinical and operational data are analyzed using the `{gsm}` R package, which generates outputs that are passed to the Gismo web application. The Appendices of this document provide detailed data specifications for the required inputs in `{gsm}` and Gismo.
