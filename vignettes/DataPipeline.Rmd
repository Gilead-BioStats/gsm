...
# Appendix 2 - `{gsm}` Input Specifications
...
+------------------+-----------------+------------------+------------------------------------------+
| **Table Source** | **Table Name**  | **Structure**    | **Description**                          |
+:=================+:================+:=================+:=========================================+
| Raw+             | {various}\*     | {various}\*      | Data for clinical KRIs/QTLs              |
+------------------+-----------------+------------------+------------------------------------------+
| RAVE             | {various}\*     | {various}\*      | Data for operational KRIs/QTLs           |
+------------------+-----------------+------------------+------------------------------------------+
| CTMS             | meta_study      | Study            | Study metadata                           |
+------------------+-----------------+------------------+------------------------------------------+
| CTMS             | meta_site       | Study/Site       | Site metadata                            |
+------------------+-----------------+------------------+------------------------------------------+
| RACT             | config_workflow | Study/Workflow   | Study-specific workflow configuration    |
+------------------+-----------------+------------------+------------------------------------------+
| RACT             | config_param    | Study/Workflow/\ | Study-specific workflow parameterization |
|                  |                 | Parameter        |                                          |
+------------------+-----------------+------------------+------------------------------------------+
| Custom           | config_schedule | Study/date       | Study snapshot schedule                  |
+------------------+-----------------+------------------+------------------------------------------+
| GSM              | meta_workflow   | Workflow         | Metadata for each workflow               |
+------------------+-----------------+------------------+------------------------------------------+
| GSM              | meta_param      | Workflow/\       | Parameter metadata for each workflow     |
|                  |                 | Parameter        |                                          |
+------------------+-----------------+------------------+------------------------------------------+
