...
Each Report will be part of a qualified package and have standard configuration files: 
...
- `Analytics_*`: The output data tables of the `{gsm}` analytics workflow, specified in the [Analytics Workflow Vignette](LINK)
