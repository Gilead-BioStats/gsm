...
For more details on any of these tables, see the [Data Model vignette](https://gilead-biostats.github.io/gsm/articles/DataModel.html).
...
An more detailed explanation of the `Param`s for each group level can be found in the [Data Model Vignette](DataModel.html) 
