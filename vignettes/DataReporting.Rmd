...
lWorkflow <- MakeWorkflowList(strPath = "workflow/metrics", strNames = "kri")
...
dfSiteCounts <- RunQuery(df = mapped$Mapped_Enrolled,
...
dfStudyCounts <- RunQuery(df = mapped$Mapped_Enrolled,
...
dfCountryCounts <- RunQuery(df = mapped$Mapped_Enrolled,
