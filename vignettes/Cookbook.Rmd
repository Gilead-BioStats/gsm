...
`Visualize_Metric()` calls all relevant helper functions in order to create the following charts:
 ...
 An example of how to create a single static `scatter` chart is outlined in the following example.
