...
This vignette contains sample code showing how to use the Good Statistical Monitoring `{gsm}`suite of  packages using sample data from `{gsm.core}`. For more information on the `{gsm}`suite of packages see the [package homepage](https://gilead-biostats.github.io/gsm/).
