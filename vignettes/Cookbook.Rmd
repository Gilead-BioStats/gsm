...
This examples introduces YAML workflows to re-generate the same results as in **Example 1** via a reusable pipeline. See the [Data Pipeline Vignette](https://gilead-biostats.github.io/gsm/articles/DataPipeline.html) for more detail.
...
This example extends the previous examples to generate charts and reports for multiple KRIs. See the 
