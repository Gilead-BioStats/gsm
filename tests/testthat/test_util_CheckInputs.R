...
test_that("output is created as expected", {
  ...
  expect_equal(names(checks$dfInput$tests_if),
               c("is_data_frame", "has_required_params", "spec_is_list", "mapping_is_list",
...
test_that("common errors are caught", {
  ...
  expect_equal(check_na$dfInput$tests_if$columns_have_na$warning,
