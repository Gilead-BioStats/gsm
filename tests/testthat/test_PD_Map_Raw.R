...
input_spec <- yaml::read_yaml(paste0(inst_path, 'specs/PD_Map_Raw.yaml'))
input_mapping <- yaml::read_yaml(paste0(inst_path, 'mappings/PD_Map_Raw.yaml'))

output_spec <- yaml::read_yaml(paste0(inst_path, 'specs/PD_Assess.yaml'))
output_mapping <- yaml::read_yaml(paste0(inst_path, 'mappings/PD_Assess.yaml'))
