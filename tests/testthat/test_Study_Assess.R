...
test_that("output is created as expected", {
    ...
    expect_equal(names(result$ae$lResults), c("strFunctionName", "lParams", "lTags", "dfInput", "dfTransformed",
...
test_that("Study_Assess() runs with missing datasets", {
  ...
  expect_equal(names(result$ae$lResults), c("strFunctionName", "lParams", "lTags", "dfInput", "dfTransformed",
                                         "dfAnalyzed", "dfFlagged", "dfSummary", "chart", "lChecks"))
  expect_equal(names(result$pd$lResults), c("strFunctionName", "lParams", "lTags", "dfInput", "dfTransformed",
                                         "dfAnalyzed", "dfFlagged", "dfSummary", "chart", "lChecks"))
...
test_that("lTags are carried through", {
  ...
  expect_equal(
    ...
    list(Study = "test study", Q = "Q2 2022", Region = "Northwest",
