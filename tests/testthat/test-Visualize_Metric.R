...
test_that("Visualize_Metric processes data correctly", {
  charts <- Visualize_Metric(reportingResults, reportingBounds, reportingGroups, reportingMetrics, strMetricID = "kri0001")
...
test_that("Visualize_Metric can run on just results", {
  charts <- Visualize_Metric(filter(reportingResults, MetricID == "kri0001"))
