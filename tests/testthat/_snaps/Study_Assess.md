...
=======
      ...
      # ... with 290 more rows, and abbreviated variable name 1: lbtstnam
      ...
      # ... with 290 more rows, and abbreviated variable names 1: n_data_points,
      #   2: n_data_points_with_changes, 3: n_data_point_changes
      
      $dfDATAENT
      # A tibble: 300 x 4
         subjid foldername form                              data_entry_lag_fl
         <chr>  <chr>      <chr>                             <chr>            
       1 0001   Day 1      Enrollment                        N                
       2 0001   Day 1      PK                                N                
       3 0001   Day 1      Prior and Concomitant Medication  N                
       4 0001   Day 1      Study Drug Accountability         N                
       5 0001   Day 1      Study Drug Administration (DRUG1) N                
       6 0001   Day 1      Study Drug Administration (DRUG2) N                
       7 0001   Day 1      Study Drug Administration (DRUG3) N                
       8 0001   Day 1      Study Drug Administration (PK)    N                
       9 0001   Day 1      Visit Date                        N                
      10 0001   Day 1      Vital Signs Performed             N                
      # ... with 290 more rows
      
      $dfQUERY
      # A tibble: 300 x 4
         subjid foldername  form                              qry30fl
         <chr>  <chr>       <chr>                             <chr>  
       1 0001   Day 1       Study Drug Administration (DRUG1) N      
       2 0001   Day 1       Visit Date                        Y      
       3 0001   Unscheduled PK                                N      
       4 0001   Unscheduled Study Drug Administration (PK)    N      
       5 0001   Week 12     Study Drug Administration (DRUG3) N      
       6 0001   Week 12     Visit Date                        N      
       7 0001   Week 12     Vital Signs Performed             N      
       8 0001   Week 16     Study Drug Administration (DRUG1) N      
       9 0001   Week 20     Prior and Concomitant Medication  N      
      10 0001   Week 20     Study Drug Administration (DRUG1) N      
      # ... with 290 more rows
