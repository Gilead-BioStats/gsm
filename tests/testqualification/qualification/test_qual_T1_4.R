test_that("AE assessment can return a correctly assessed data frame for the identity test grouped by the site variable when given subset input data from safetyData and the results should be flagged correctly.", {
  # gsm analysis
