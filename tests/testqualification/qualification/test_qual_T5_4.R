test_that("Disposition assessment can return a correctly assessed data frame for the identity test grouped by the study variable when given subset input data from clindata and the results should be flagged correctly", {
  # gsm analysis
