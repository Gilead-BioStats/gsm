test_that("Raw+ study disposition data can be mapped correctly to create an analysis-ready input dataset that has properly merged demographics and study disposition data with one record per subject.", {
