test_that("A subset of rawplus Study Treatment Disposition data can be mapped correctly to create an analysis-ready input dataset.", {
  ########### gsm mapping ###########
  subset <- FilterData(
    dfInput = clindata::rawplus_sdrgcomp,
    strCol = "sdrgreas",
    anyVal = "ADVERSE EVENT"
  ) # filtering only for subjects who discontinued study treatment due to an AE
