test_that("Data entry assessment can return a correctly assessed data frame for the identity test grouped by the country variable when given subset input data from clindata and the results should be flagged correctly.", {
  # gsm analysis
