test_that("A subset of raw data entry data can be mapped correctly to create an analysis-ready input dataset.", {
  ...
  # count unique number of PK data forms with data entry lag (i.e., >10 days between the visit date and the earliest field entry date - where data_entry_lag_fl == "Y") within each subject and remove duplicate records
  ...
  # count number of overall PK data forms within each subject and remove duplicate records
