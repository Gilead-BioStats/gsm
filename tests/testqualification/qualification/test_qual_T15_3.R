test_that("rawplus Labs data can be mapped correctly to create an analysis-ready input dataset which accurately calculates the number of abnormal lab values and total number of lab values reported per subject.", {
  ########### gsm mapping ###########
  ...
  ########### testing ###########
  # check that calculated number of abnormal lab values per subject is correct/consistent
  num_events <- unique(observed$Count == expected$Count)

  # check that calculated total number of lab values reported per subject is correct/consistent
