test_that("rawplus Study Disposition data can be mapped correctly to create an analysis-ready input dataset which accurately calculates the number of subjects who discontinued from the study.", {
  ########### gsm mapping ###########
  ...
  ########### testing ###########
  # check that calculated number of subjects who discontinued from the study is correct/consistent
