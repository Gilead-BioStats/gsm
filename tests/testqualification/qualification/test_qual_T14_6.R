test_that("Raw+ study drug disposition data can be mapped correctly to create an analysis-ready input dataset which accurately calculates the number of subjects who discontinued use of study drug.", {
  ...
  ########### testing ###########
  # check that calculated number of subjects who discontinued use of study drug is correct/consistent
